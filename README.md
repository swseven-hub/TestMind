...
1. 需求评审智能体：粘贴 PRD 片段、需求说明或评审纪要，输出需求疑点、边界条件、异常场景、权限与数据风险、检查清单和下一步动作。
...
| 需求评审 | 粘贴需求材料，输出疑点、边界、异常、权限、风险、检查清单和下一步 |
...
需求评审和发布风险智能体支持无 API Key 的本地规则兜底；配置 DeepSeek、阿里云百炼、OpenAI 或 Velotric Key 后会调用模型生成结构化报告。
